...
import com.fireworks.common.api.UserDetailsThreadLocal;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (!StringUtils.hasText(authHeader) || !authHeader.startsWith(tokenHead)) {
                log.debug("请求 [{} {}] 未携带有效 Authorization 头，跳过 JWT 认证",
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                AdminUserDetails userDetails = RedisUtil.get(
                        RedisKeyConstant.USER_INFO_KEY + username, AdminUserDetails.class);
                ...
                if (jwtTokenUtil.validateToken(authToken, userDetails)) {
                    UserDetailsThreadLocal.setUserDetails(userDetails);
            ...
            UserDetailsThreadLocal.removeUserDetails();
        }
    }
}
